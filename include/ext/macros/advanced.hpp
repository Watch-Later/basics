...
#define eXT_ZERO_IF_ONE_ARG(...) EXT_GET2ND(__VA_ARGS__, 0, )
#define eXT_SET2ND_TO_ONE(first) first, 1

// Now we can test for the marker if it gets expanded
// the 2nd arg should be set to 1 and that shall be returned
#define EXT_TEST eXT_ZERO_IF_ONE_ARG
#define EXT_MARK eXT_SET2ND_TO_ONE
